...
The solution has a Sharpe Ratio of `r round(bayes_finance_naive$value, 4)` which is even higher than the previous one! However, keep in mind that this only works after setting `n_iter` to only 1 iteration.
