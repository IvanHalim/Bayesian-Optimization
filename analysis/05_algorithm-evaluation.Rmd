...
```
The solution has a Sharpe Ratio of `r round(bayes_finance_norm$value, 4)`. We achieve a higher performance than `rBayesianOptimization` or Particle Swarm Optimization, and in just one iteration!
